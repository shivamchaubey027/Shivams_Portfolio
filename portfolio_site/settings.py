...
# Email config from environment for security
...
CLOUDINARY_STORAGE = {
    'CLOUD_NAME': config('CLOUDINARY_CLOUD_NAME', default=''), # Add default=''
    'API_KEY': config('CLOUDINARY_API_KEY', default=''), # Add default=''
    'API_SECRET': config('CLOUDINARY_API_SECRET', default=''), # Add default=''
}
